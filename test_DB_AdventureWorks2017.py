...
class TestDataBase:
    ...
    conn = pyodbc.connect( 'Driver={ODBC Driver 17 for SQL Server};' f'Server={EPBYMINW0F9F};' 'Port:{1433};' f'Database={AdventureWorks2017};' f'UID={TestUserKikar};' f'PWD={test123};' 'Trusted_Connection=yes;')
